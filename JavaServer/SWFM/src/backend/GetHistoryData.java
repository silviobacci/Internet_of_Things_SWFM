...
@WebServlet(name = "gethistorydata", urlPatterns={"/backend/gethistorydata"}, loadOnStartup = 1)
public class GetHistoryData  extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		...
		resp.getWriter().println("GET RESPONSE FROM: gethistorydata");
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		...
		JSONArray response = mng.getHistoryData((String) payload.get("id"));
