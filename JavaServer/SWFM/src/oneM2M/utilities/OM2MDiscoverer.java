...
public class OM2MDiscoverer {
	...
	public synchronized ArrayList<OM2MResource> discoveryAE() {
		return discovery(CSE_ID, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryAE(ArrayList<String> filter) {
		return discovery(CSE_ID, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryAE(String id) {
		return discovery(id, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryAE(String id, ArrayList<String> filter) {
		return discovery(id, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<String> discoveryAErUril() {
		return discoveryUril(CSE_ID, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<String> discoveryAErUril(ArrayList<String> filter) {
		return discoveryUril(CSE_ID, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<String> discoveryAErUril(String id) {
		return discoveryUril(id, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<String> discoveryAErUril(String id, ArrayList<String> filter) {
		return discoveryUril(id, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContainer() {
		return discovery(CSE_ID, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContainer(ArrayList<String> filter) {
		return discovery(CSE_ID, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContainer(String id) {
		return discovery(id, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContainer(String id, ArrayList<String> filter) {
		return discovery(id, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<String> discoveryContainerUril() {
		return discoveryUril(CSE_ID, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<String> discoveryContainerUril(ArrayList<String> filter) {
		return discoveryUril(CSE_ID, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<String> discoveryContainerUril(String id) {
		return discoveryUril(id, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<String> discoveryContainerUril(String id, ArrayList<String> filter) {
		return discoveryUril(id, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContentInstance() {
		return discovery(CSE_ID, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContentInstance(ArrayList<String> filter) {
		return discovery(CSE_ID, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContentInstance(String id) {
		return discovery(id, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryContentInstance(String id, ArrayList<String> filter) {
		return discovery(id, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<String> discoveryContentInstancerUril() {
		return discoveryUril(CSE_ID, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<String> discoveryContentInstancerUril(ArrayList<String> filter) {
		return discoveryUril(CSE_ID, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<String> discoveryContentInstancerUril(String id) {
		return discoveryUril(id, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<String> discoveryContentInstancerUril(String id, ArrayList<String> filter) {
		return discoveryUril(id, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryRemoteCSE() {
		return discovery(CSE_ID, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryRemoteCSE(ArrayList<String> filter) {
		return discovery(CSE_ID, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryRemoteCSE(String id) {
		return discovery(id, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoveryRemoteCSE(String id, ArrayList<String> filter) {
		return discovery(id, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<String> discoveryRemoteCSEUril() {
		return discoveryUril(CSE_ID, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<String> discoveryRemoteCSEUril(ArrayList<String> filter) {
		return discoveryUril(CSE_ID, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<String> discoveryRemoteCSEUril(String id) {
		return discoveryUril(id, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<String> discoveryRemoteCSEUril(String id, ArrayList<String> filter) {
		return discoveryUril(id, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoverySubscription() {
		return discovery(CSE_ID, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoverySubscription(ArrayList<String> filter) {
		return discovery(CSE_ID, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<OM2MResource> discoverySubscription(String id) {
		return discovery(id, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<OM2MResource> discoverySubscription(String id, ArrayList<String> filter) {
		return discovery(id, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<String> discoverySubscriptionUril() {
		return discoveryUril(CSE_ID, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<String> discoverySubscriptionUril(ArrayList<String> filter) {
		return discoveryUril(CSE_ID, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<String> discoverySubscriptionUril(String id) {
		return discoveryUril(id, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<String> discoverySubscriptionUril(String id, ArrayList<String> filter) {
		return discoveryUril(id, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryAE(String csi) {
		return bridgedDiscovery(csi, null, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryAE(String csi, ArrayList<String> filter) {
		return bridgedDiscovery(csi, null, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryAE(String csi, String id) {
		return bridgedDiscovery(csi, id, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryAE(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscovery(csi, id, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryAErUril(String csi) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryAErUril(String csi, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryAErUril(String csi, String id) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.AE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryAErUril(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.AE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContainer(String csi) {
		return bridgedDiscovery(csi, null, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContainer(String csi, ArrayList<String> filter) {
		return bridgedDiscovery(csi, null, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContainer(String csi, String id) {
		return bridgedDiscovery(csi, id, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContainer(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscovery(csi, id, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContainerUril(String csi) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContainerUril(String csi, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContainerUril(String csi, String id) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.CONTAINER, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContainerUril(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.CONTAINER, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContentInstance(String csi) {
		return bridgedDiscovery(csi, null, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContentInstance(String csi, ArrayList<String> filter) {
		return bridgedDiscovery(csi, null, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContentInstance(String csi, String id) {
		return bridgedDiscovery(csi, id, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryContentInstance(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscovery(csi, id, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContentInstanceUril(String csi) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContentInstanceUril(String csi, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContentInstanceUril(String csi, String id) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.CONTENT_INSTANCE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryContentInstanceUril(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.CONTENT_INSTANCE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryRemoteCSE(String csi) {
		return bridgedDiscovery(csi, null, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryRemoteCSE(String csi, ArrayList<String> filter) {
		return bridgedDiscovery(csi, null, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryRemoteCSE(String csi, String id) {
		return bridgedDiscovery(csi, id, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoveryRemoteCSE(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscovery(csi, id, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryRemoteCSEUril(String csi) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryRemoteCSEUril(String csi, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryRemoteCSEUril(String csi, String id) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.REMOTE_CSE, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoveryRemoteCSEUril(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.REMOTE_CSE, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoverySubscription(String csi) {
		return bridgedDiscovery(csi, null, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoverySubscription(String csi, ArrayList<String> filter) {
		return bridgedDiscovery(csi, null, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoverySubscription(String csi, String id) {
		return bridgedDiscovery(csi, id, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<OM2MResource> bridgedDiscoverySubscription(String csi, String id, ArrayList<String> filter) {
		return bridgedDiscovery(csi, id, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoverySubscriptionUril(String csi) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoverySubscriptionUril(String csi, ArrayList<String> filter) {
		return bridgedDiscoveryUril(csi, null, OM2MConstants.SUBSCRIPTION, filter);
	}
	
	public synchronized ArrayList<String> bridgedDiscoverySubscriptionUril(String csi, String id) {
		return bridgedDiscoveryUril(csi, id, OM2MConstants.SUBSCRIPTION, null);
	}
	
	public synchronized ArrayList<String> bridgedDiscoverySubscriptionUril(String csi, String id, ArrayList<String> filter) {
