		...
		if(reply.error == false && reply.message.length != 0 && reply.message != null) {
			for(var i = 0; i < reply.message.length; i++) {
				if(reply.message[i] != undefined && reply.message[i] != null) {
					...
					if(this.ae[index] != undefined && this.ae[index].reference_id != undefined && this.ae[index].ae_id != undefined && this.ae[index].ae_name != undefined && this.ae[index].lat != undefined && this.ae[index].lng != undefined && this.ae[index].level != undefined && this.ae[index].message != undefined)
