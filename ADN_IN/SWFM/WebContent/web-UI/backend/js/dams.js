class Dams {
	...
	print_what_miss(dam) {
		...
		if(dam.dam_id == undefined) console.log("dam_id");
		if(dam.dam_name == undefined) console.log("dam_name");
		if(dam.lat == undefined) console.log("lat");
		if(dam.lng == undefined) console.log("lng");
		if(dam.state == undefined) console.log("state");
		if(dam.creation_time == undefined) console.log("creation_time");
		if(dam.is_working == undefined) console.log("is_working");
	}
				...
				if(reply.message[i] != undefined && reply.message[i] != null) {
					...
					if(this.dams[index] != undefined && this.dams[index].dam_id != undefined && this.dams[index].dam_name != undefined && this.dams[index].lat != undefined && this.dams[index].lng != undefined && this.dams[index].state != undefined && this.dams[index].is_working != undefined && this.dams[index].creation_time != undefined) {
						...
						if(this.written[index]) {
							...
							console.log(this.dams[index].dam_name);
						}
