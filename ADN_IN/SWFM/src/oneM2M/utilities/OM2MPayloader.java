...
public class OM2MPayloader {
	...
	public static JSONObject jsonAE(String api, String rn) {
		return create_jsonAE(api, rn, true, null);
	}
	
	public static JSONObject jsonAE(String api, String rn, ArrayList<String> lbl) {
	...
	public static JSONObject create_jsonContainer(String rn, ArrayList<String> lbl) {
		JSONObject jo = new JSONObject();
		jo.put("rn", rn);
		jo.put("lbl", lbl);
	...
	public static JSONObject jsonContentInstance(String rn, String cnf, Object con, ArrayList<String> lbl) {
		return create_jsonContentInstance(rn, cnf, con, lbl);
	}
	
	public static JSONObject jsonContentInstance(String cnf, Object con, ArrayList<String> lbl) {
	...
	public static JSONObject jsonSubscription(String rn, String nu, int nct, ArrayList<String> lbl) {
