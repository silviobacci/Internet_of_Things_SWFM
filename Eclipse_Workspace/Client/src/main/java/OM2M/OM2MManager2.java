...
public class OM2MManager2 {
	...
	private static String getCSE(boolean isMN) {
		if(isMN)
			return mnCSE;
		else
			return inCSE;
	...
	public synchronized static String createResource(boolean isMN, String id_father, String resource_type, int type, JSONObject body) {		
	...
	public static CoapResponse getRequest(String address) {
	...
	public static InstanceResource getBridgedContentInstance(boolean isMN, String csi, String id) {
