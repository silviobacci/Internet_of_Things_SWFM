...
public class InstallerMN extends Thread {
	...
	public InstallerMN(String ip) {
		mng = new OM2MManager("127.0.0.1", 5684, "/SWFM-mn-cse");
	...
	public void createMN() {
		...
		// AE
		JSONObject json = OM2MPayloader.jsonAE("PESCIA-ID", "PESCIA", true);
		...
		gps.put(Marker.LAT, 43.843176);
		gps.put(Marker.LNG, 10.734928);
		...
		state.put(Marker.RISK_LEVEL, 1);
		state.put(Marker.RISK_MESSAGE, "Tutto ok");
