...
public class OM2MUtilities {
	public synchronized static ArrayList<String> createFilters(String... label) {
	...
	public synchronized static ArrayList<String> createLabels(String... label) {
		ArrayList<String> labels = new ArrayList<String>();
	...
	public synchronized static ArrayList<OM2MResource> filterByName(ArrayList<OM2MResource> r, String name) {
	...
	public synchronized static ArrayList<OM2MResource> getResourcesByName(ArrayList<OM2MResource> r, String name) {
		Iterator<OM2MResource> iter = r.iterator();
		while(iter.hasNext()) {
		    if(!iter.next().getRn().equals(name))
		        iter.remove();
	...
	public synchronized static ArrayList<String> getResourcesById(ArrayList<String> r, String id) {
