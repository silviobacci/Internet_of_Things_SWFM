...
import assets.ServerNotifierDam;
...
public class GetDamData extends HttpServlet {
	...
	private boolean createNewContext(HttpServletRequest req, HttpServletResponse resp, String reference_id, String ae_id, String ae_name) {
		...
		ServerNotifierDam notifier = new ServerNotifierDam(req, resp, reference_id, ae_id, ae_name);
	...
	private void sendNotification(HttpServletRequest req, String reference_id, String ae_id, String ae_name) {
		...
		contexts.get(username).sendNotification(new QueryManagerIN().getDamData(reference_id, ae_id, ae_name));
	}
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		...
		if(dam_id == null)
			...
			response = mng.getSensorData(reference_id, ae_id, ae_name, dam_id);
