...
public class JSONParser {
	...
	public static final String MN_CSE	= "mn_cse";
	public static final String MANAGER_PERIOD	= "manager_period";
	public static final String CONTROLLER_PERIOD	= "controller_period";
	...
	public static void setConfProperties() {
		...
		jProperties.add(MANAGER_PERIOD);
		jProperties.add(CONTROLLER_PERIOD);
		jProperties.add(LAT);
		jProperties.add(LNG);
		jProperties.add(NAME);
		jProperties.add(MN_CSE);
	}
