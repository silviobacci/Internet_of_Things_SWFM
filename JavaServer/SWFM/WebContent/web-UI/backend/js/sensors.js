class Sensors {
	...
	map_cooja_coordinates(index) {
		...
		var cooja_canvas_end = 33;
		
		var browser_canvas_start = 0;
		var browser_canvas_end = 33;
			
		var slope = (browser_canvas_end - browser_canvas_start) / (cooja_canvas_end - cooja_canvas_start)

		this.sensors[index].x = (browser_canvas_start + slope * (this.sensors[index].lat - cooja_canvas_start - 1)) * this.tile_width + 8;
		this.sensors[index].y = (browser_canvas_start + slope * (this.sensors[index].lng - cooja_canvas_start - 1)) * this.tile_height + 6;
