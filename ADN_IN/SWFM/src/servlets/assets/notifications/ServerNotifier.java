...
public abstract class ServerNotifier implements Observer {
	...
	private ServerNotifierListener listener;
	...
	public ServerNotifier(AsyncContextInterface f, HttpServletRequest request, HttpServletResponse response) {
		...
		listener = new ServerNotifierListener(this);
		context.addListener(listener);
		
		INManagerNotifier.addObserver(this);
	...
	private class ServerNotifierListener implements AsyncListener {
		ServerNotifier notifier;
		
		public ServerNotifierListener(ServerNotifier n) {
			notifier = n;
		}
