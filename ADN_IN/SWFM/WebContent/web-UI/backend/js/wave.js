class Wave {
	...
	wave_animation(timestamp, first_time) {
		...
		this.context.drawImage(this.wave, this.position, this.background.height - this.level - 30, this.wave.width, this.wave.height);
		this.context.drawImage(this.wave, this.position - this.wave.width,  this.background.height - this.level - 30, this.wave.width, this.wave.height);
