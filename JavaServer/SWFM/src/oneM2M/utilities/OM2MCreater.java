...
public class OM2MCreater {
	...
	public synchronized String createBridgedResource(String csi, String id_father, String resource_type, int type, JSONObject body) {	
		String name = csi;
		if(id_father != null)
	...
	public synchronized AEResource createAE(JSONObject body) {		
	...
	public synchronized ContainerResource createContainer(String id_father, JSONObject body) {
	...
	public synchronized InstanceResource createContentInstance(String id_father, JSONObject body) {
	...
	public synchronized SubscriptionResource createSubscription(String id_father, JSONObject body) {
	...
	public synchronized AEResource createBridgedAE(String csi, String cse_id, JSONObject body) {	
	...
	public synchronized ContainerResource createBridgedContainer(String csi, String id_father, JSONObject body) {
	...
	public synchronized InstanceResource createBridgedContentInstance(String csi, String id_father, JSONObject body) {
	...
	public synchronized SubscriptionResource createBridgedSubscription(String csi, String id_father, JSONObject body) {
